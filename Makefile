...
MinNO.exe: MinNO.cu Connection.h
	$(NVCC) -I. -I$(INCLUDE) -I$(INCLUDE_GRPC_WIN) -I$(INCLUDE_GOOGLE_WIN) -D_WIN32_WINNT=0x0600 $(GRPC_FILES) MinNO.cu submodules/grpc/bin/grpc/release/gpr.lib submodules/grpc/bin/grpc/release/grpc++.lib submodules/grpc/bin/grpc/release/grpc.lib submodules/grpc/bin/protobuf/release/libprotoc.lib submodules/grpc/bin/protobuf/release/libprotobuf.lib submodules/grpc/bin/dependencies/libeay32.lib submodules/grpc/bin/dependencies/ssleay32.lib submodules/grpc/bin/zlib/release/lib/zlibstatic.lib -o MinNO.exe  -L$(WINDOW_LIB) $(WINDOW_FLAGS)
